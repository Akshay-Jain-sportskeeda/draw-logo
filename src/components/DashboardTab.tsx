    ...
    const fetchUserStats = async () => {
      if (isLoggedIn && userId && getUserStats) {
        ...
        try {
          ...
          setUserStats(stats);
          if (stats) {
            trackUserStatsView(stats.totalGames, stats.currentStreakDrawMemory + stats.currentStreakCreativeRemix);
          }
        } catch (error) {
        } finally {
          setLoading(false);
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-yellow-50 rounded-lg p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-yellow-600">{userStats.currentStreakDrawMemory}</div>
                    <div className="text-sm text-gray-600">Draw Memory Streak</div>
                  </div>

                  <div className="bg-green-50 rounded-lg p-4 text-center">
                    <Target className="w-6 h-6 text-green-600 mx-auto mb-2" />
                    <div className="text-2xl font-bold text-green-600">{userStats.currentStreakCreativeRemix}</div>
                    <div className="text-sm text-gray-600">Creative Remix Streak</div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h4 className="font-semibold text-gray-800">
                        Free Draws Submitted
                      </h4>
                    </div>
                    <div className="text-3xl font-bold text-green-600 mb-1">{userStats.unassistedGamesCount}</div>
                    <div className="text-sm text-gray-600">Creative submissions with no hints</div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-gray-700">Average Accuracy</span>
                      </div>
                      <span className="text-xl font-bold text-gray-800">{userStats.averageAccuracy.toFixed(1)}%</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xl font-bold text-gray-800">{userStats.averageScore.toFixed(0)}</span>
                    </div>
                  </div>
