...
export default function Home() {
  ...
  // Challenge data with different logos
  const challenges = [
    {
  ...
  // Fetch logo colors when component mounts
  useEffect(() => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          try {
            ...
            // Response body is not valid JSON, use generic error message
